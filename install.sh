...
sed -i '/SQLALCHEMY_DATABASE_URI/c\SQLALCHEMY_DATABASE_URI = "sqlite:////home/kali/opt/data/app.db"' ./polichombr/config.py
sed -i '/STORAGE_PATH/c\STORAGE_PATH = "/home/kali/opt/data/storage"' ./polichombr/config.py
